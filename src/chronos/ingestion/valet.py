        ...
        for series_id in series_ids:
            try:
                ...
                response = self.http_session.get(
                    url, params={"recent": 1}, timeout=30  # Get 1 recent observation
                )
                ...
                if not series_info:
                    ...
                    series_info = {"label": series_id, "frequency": "daily"}  # Default for FX
    ...
    def fetch_observations(
        ...
        try:
            ...
            if not observations_raw:
                self.logger.warning("no_observations_returned", series_id=series_id, params=params)
                return []
            ...
            for obs in observations_raw:
                try:
                    ...
                    if value is not None:
                        try:
                            valid_obs.append({"date": obs_date, "value": float(value)})
            ...
            self.logger.critical("observations_unexpected_error", series_id=series_id, error=str(e))
