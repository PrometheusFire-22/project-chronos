import { pgTable, uuid, text, integer, timestamp, uniqueIndex, boolean, pgSchema } from 'drizzle-orm/pg-core';
import { sql } from 'drizzle-orm';

/**
 * Auth schema for Better Auth tables and related user data.
 * All tables in this schema are prefixed with 'auth.' in PostgreSQL.
 */
