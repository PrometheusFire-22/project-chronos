    ...
    <section className="relative bg-muted/30 py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="group p-6 rounded-2xl bg-card border border-border hover:border-foreground/20 transition-all duration-300">
            {/* Avatar Placeholder */}
            ...
            <div className="text-center mb-4">
              <h3 className="text-xl font-bold text-foreground mb-1">Founding Team</h3>
              <p className="text-muted-foreground">Engineering & Product</p>
            </div>
