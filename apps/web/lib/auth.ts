...
/**
 * Better Auth configuration using Neon Serverless Pool with Drizzle adapter.
 *
 * This setup works with:
 * - Standard PostgreSQL via DATABASE_URL (local dev)
 * - Cloudflare Hyperdrive (edge production)
 *
 * @neondatabase/serverless is edge-compatible and can connect to any PostgreSQL server.
 */

// Create database pool - works with standard PostgreSQL
const pool = new Pool({
