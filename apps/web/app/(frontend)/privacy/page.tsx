          ...
          <div className="text-slate-300 space-y-8">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Chronos ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, use our platform, or engage our consulting services.
              </p>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">Business Data</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <p className="leading-relaxed mt-3">
                To exercise these rights, please contact us at privacy@chronos.com.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 p-6 rounded-lg bg-slate-900/50 border border-slate-800">
                <p className="leading-relaxed">
                  <strong>Email:</strong> privacy@chronos.com<br />
            ...
            {/* GDPR & CCPA Specific */}
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">Additional Rights for EU and California Residents</h2>

              <h3 className="text-xl font-semibold text-white mb-3 mt-6">GDPR (EU Residents)</h3>
              <p className="leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-white mb-3 mt-6">CCPA (California Residents)</h3>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed mt-3">
                Note: Chronos does not sell personal information.
              </p>
            </section>
          </div>
        </div>
