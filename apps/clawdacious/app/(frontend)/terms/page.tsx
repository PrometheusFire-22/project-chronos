...
export const metadata: Metadata = {
  title: 'Terms of Service - Clawdacious',
  description: 'Terms and conditions for using the Clawdacious platform and services.',
  keywords: ['terms', 'conditions', 'legal', 'agreement'],
  openGraph: {
    title: 'Terms of Service - Clawdacious',
    description: 'Terms and conditions governing your use of Clawdacious.',
    type: 'website',
  },
}
          ...
          <div className="text-foreground/80 space-y-8">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                These Terms of Service ("Terms") constitute a legally binding agreement between you and Clawdacious ("Company," "we," "us," or "our") concerning your access to and use of our website, platform, and consulting services (collectively, the "Services").
              </p>
              <p className="leading-relaxed">
            ...
            {/* Acceptable Use */}
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Acceptable Use Policy</h2>
              <p className="leading-relaxed">
                You agree not to:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                The Services and all content, features, and functionality (including but not limited to software, text, displays, images, video, audio, design, and data compilations) are owned by Clawdacious and are protected by copyright, trademark, patent, trade secret, and other intellectual property laws.
              </p>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Feedback</h3>
              <p className="leading-relaxed">
            ...
            {/* Consulting Services */}
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Consulting Services Terms</h2>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Fees</h3>
              <p className="leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Subscriptions</h3>
              <p className="leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Taxes</h3>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">Data Use and Confidentiality</h2>
              <p className="leading-relaxed">
                Our collection and use of your data is governed by our <Link href="/privacy" className="text-red-400 hover:text-red-300">Privacy Policy</Link>. By using the Services, you acknowledge and agree to such collection and use.
              </p>
              <p className="leading-relaxed mt-3">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Investment Advice</h3>
              <p className="leading-relaxed">
                CLAWDACIOUS IS NOT A REGISTERED INVESTMENT ADVISOR. INFORMATION PROVIDED THROUGH THE SERVICES IS FOR INFORMATIONAL PURPOSES ONLY AND DOES NOT CONSTITUTE INVESTMENT, FINANCIAL, OR LEGAL ADVICE. YOU ARE SOLELY RESPONSIBLE FOR YOUR INVESTMENT DECISIONS.
              </p>

              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Data Accuracy</h3>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, CLAWDACIOUS AND ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                You agree to indemnify, defend, and hold harmless Clawdacious and its affiliates, officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including legal fees) arising out of or related to:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Class Action Waiver</h3>
              <p className="leading-relaxed">
                You agree that any arbitration or proceeding shall be limited to the dispute between you and Clawdacious individually. CLASS ACTIONS, CLASS ARBITRATIONS, AND REPRESENTATIVE ACTIONS ARE NOT PERMITTED.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                These Terms, together with our Privacy Policy and any additional agreements for specific Services, constitute the entire agreement between you and Clawdacious regarding the Services and supersede all prior agreements and understandings.
              </p>
            </section>
