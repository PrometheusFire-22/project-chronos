...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: 'Post Not Found | Clawdacious',
    }
  }

  return {
    title: `${post.title} | Clawdacious Blog`,
    description: post.excerpt || post.meta_description || `Read ${post.title} on the Clawdacious blog`,
    openGraph: {
      ...
      <article className="relative py-12 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Article Content */}
            <div
              className="prose prose-invert dark:prose-invert prose-lg max-w-none
