...
export const metadata: Metadata = {
  title: 'Blog | Clawdacious',
  description: 'Insights, updates, and best practices for AI assistants and business automation.',
  openGraph: {
    title: 'Blog | Clawdacious',
    description: 'Insights, updates, and best practices for AI assistants and business automation.',
  },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300">
              Insights, updates, and best practices for AI assistants and business automation.
            </p>
          </div>
        </div>
      </section>
