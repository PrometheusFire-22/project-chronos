...
| **Prioritization Framework** | The RICE framework provides a data-driven method for selecting the most valuable analytical verticals to pursue. | `docs/5_decisions/rice_analysis.csv` |
